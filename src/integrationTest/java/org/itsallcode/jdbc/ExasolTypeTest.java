...
class ExasolTypeTest {
    ...
    private static final ExasolContainer<?> container = new ExasolContainer<>("8.26.0")
    ...
    void genericRowType(final TypeTest test) {
        try (final SimpleResultSet<Row> result = connect()
            ...
            assertAll(
                    ...
                    () -> assertThat(columnValue.type().jdbcType()).as("jdbc type").isEqualTo(test.expectedType()),
                    () -> assertThat(columnValue.type().typeName()).as("type name").isEqualTo(test.expectedTypeName()),
    ...
    void genericRowNullValue(final TypeTest test) {
        try (SimpleResultSet<Row> result = connect()
            ...
            assertAll(
                    ...
                    () -> assertThat(value.type().typeName()).isEqualTo(test.expectedTypeName()));
        }
    }
    ...
    static Stream<Arguments> testTypes() {
        return Stream.of(
                typeTest("2023-11-25 16:18:46", "timestamp", Instant.parse("2023-11-25T16:18:46.0Z"),
                        JDBCType.TIMESTAMP, "TIMESTAMP", Timestamp.class),
                typeTest("2023-11-25 16:18:46", "timestamp with local time zone",
                        Instant.parse("2023-11-25T16:18:46.0Z"),
                        JDBCType.TIMESTAMP, "TIMESTAMP", Timestamp.class),
                typeTest("2023-11-25", "date", LocalDate.parse("2023-11-25"), JDBCType.DATE, "DATE", Date.class),
                typeTest("5-3", "INTERVAL YEAR TO MONTH", "+05-03", JDBCType.VARCHAR, "INTERVAL YEAR TO MONTH",
                        String.class),
                typeTest("2 12:50:10.123", "INTERVAL DAY TO SECOND", "+02 12:50:10.123", JDBCType.VARCHAR,
                        "INTERVAL DAY TO SECOND", String.class),
                typeTest("POINT(1 2)", "GEOMETRY", "POINT (1 2)", JDBCType.VARCHAR, "GEOMETRY", String.class),
                ...
                typeTest("123", "SHORTINT", 123, JDBCType.INTEGER, "INTEGER", Long.class),
                typeTest("123", "SMALLINT", 123, JDBCType.INTEGER, "INTEGER", Long.class),
                typeTest("123", "TINYINT", (short) 123, JDBCType.SMALLINT, "SMALLINT", Long.class),
                typeTest("123", "DECIMAL(4,0)", (short) 123, JDBCType.SMALLINT, "SMALLINT", Long.class),
                typeTest("123", "DECIMAL(5,0)", 123, JDBCType.INTEGER, "INTEGER", Long.class),
                typeTest("123", "DECIMAL(9,0)", 123, JDBCType.INTEGER, "INTEGER", Long.class),
                ...
                typeTest("123", "DECIMAL(19,0)", BigDecimal.valueOf(123), JDBCType.DECIMAL, "DECIMAL", Long.class),
                typeTest("123", "INT", 123L, JDBCType.BIGINT, "BIGINT", Long.class),
                typeTest("123", "BIGINT", BigDecimal.valueOf(123), JDBCType.DECIMAL, "DECIMAL", Long.class),
                ...
                typeTest("123.457", "DECIMAL(6,3)", BigDecimal.valueOf(123.457d), JDBCType.DECIMAL, "DECIMAL",
                        Double.class),
                typeTest("123.458", "DOUBLE", 123.458d, JDBCType.DOUBLE, "DOUBLE PRECISION", Double.class),
                typeTest("123.458", "FLOAT", 123.458d, JDBCType.DOUBLE, "DOUBLE PRECISION", Double.class),
                typeTest("123.458", "NUMBER", 123.458d, JDBCType.DOUBLE, "DOUBLE PRECISION", Double.class),
                typeTest("123.458", "REAL", 123.458d, JDBCType.DOUBLE, "DOUBLE PRECISION", Double.class),
                typeTest("123.458", "DOUBLE PRECISION", 123.458d, JDBCType.DOUBLE, "DOUBLE PRECISION", Double.class),
    ...
    private static Arguments typeTest(final String value, final String type, final Object expectedValue,
        ...
        return Arguments
                .of(new TypeTest(value, type, expectedValue, expectedType, expectedTypeName, expectedClass.getName()));
    }
